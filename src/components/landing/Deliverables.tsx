...
const modules = [
  ...
  { title: "Módulo 4 — Automação com I.A", lessons: "6 aulas", desc: "Agentes de I.A para vendas, vídeos virais e automações complexas." },
  { title: "Módulo 5 — Criação de Produto do Zero", lessons: "7 aulas", desc: "Como criar SaaS MVP, infoprodutos rápidos e modelagem em tempo recorde." },
